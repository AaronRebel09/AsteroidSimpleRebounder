========================================================================
    APLICACIÓN DE CONSOLA: AsterRebotador 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación AsterRebotador.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación AsterRebotador.


AsterRebotador.vcxproj
...
AsterRebotador.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado AsterRebotador.pch y un archivo de tipos 
